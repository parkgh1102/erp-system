import{g as b,j as e}from"./index-nbVRUzM7.js";import{r as a}from"./react-vendor-DTT0EbPP.js";import{H as N,G as P,t as T,aV as B,K as M,A as v,w as $,aW as h,T as G,c as V,B as c,S as u,Q as _,ay as L,aC as Q,b as W,f as O}from"./antd-vendor-BXX65wn7.js";import"./utils-vendor-BsYhjA75.js";const{Text:k,Paragraph:Y}=G,{TextArea:H}=_,X=()=>{const{message:C}=N.useApp(),[d,f]=a.useState(!1),[p,n]=a.useState([]),[m,y]=a.useState(""),[i,j]=a.useState(!1),[o,S]=a.useState(null),A=a.useRef(null),R=()=>{A.current?.scrollIntoView({behavior:"smooth"})};a.useEffect(()=>{R()},[p]),a.useEffect(()=>{d&&!o&&w()},[d]);const w=async()=>{try{const s=await b.get("/chatbot/status");S(s.data),s.data.hasApiKey?n([{id:Date.now().toString(),role:"assistant",content:`안녕하세요! 🤖 ERP 시스템 AI 어시스턴트입니다.
