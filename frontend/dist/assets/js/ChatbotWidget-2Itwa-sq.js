import{b,j as e}from"./index-DtfMx1mg.js";import{r as a}from"./react-vendor-DlOFnj4c.js";import{H as N,G as P,t as T,aR as B,K as M,A as v,w as $,aS as u,T as G,c as _,B as c,S as g,Q as L,aA as Q,a8 as V,b as O,f as W}from"./antd-vendor-bEKfvwfc.js";import"./utils-vendor-tVPupyY7.js";const{Text:k,Paragraph:Y}=G,{TextArea:H}=L,X=()=>{const{message:C}=N.useApp(),[d,f]=a.useState(!1),[p,n]=a.useState([]),[m,y]=a.useState(""),[i,j]=a.useState(!1),[o,S]=a.useState(null),A=a.useRef(null),R=()=>{A.current?.scrollIntoView({behavior:"smooth"})};a.useEffect(()=>{R()},[p]),a.useEffect(()=>{d&&!o&&w()},[d]);const w=async()=>{try{const s=await b.get("/chatbot/status");S(s.data),s.data.hasApiKey?n([{id:Date.now().toString(),role:"assistant",content:`안녕하세요! 🤖 ERP 시스템 AI 어시스턴트입니다.
