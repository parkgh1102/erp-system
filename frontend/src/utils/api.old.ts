...
export const authAPI = {
  login: (data: { email: string; password: string }) =>
    api.post('/auth/login', data, { skipErrorHandler: true } as any),
  signup: (data: UserCreateData & { businessInfo: BusinessCreateData }) =>
    api.post('/auth/signup', data, { skipErrorHandler: true } as any),
...
export const transactionLedgerAPI = {
  ...
  getCustomerBalance: (businessId: number, customerId: number, beforeDate?: string) =>
...
export const dashboardAPI = {
  ...
  getAllTransactions: (businessId: number, params?: { startDate?: string; endDate?: string; search?: string }) =>
...
export const settingsAPI = {
  ...
  exportCustomers: (businessId: number) =>
    api.get(`/settings/${businessId}/export/customers`, {
      responseType: 'blob'
    }),
  exportProducts: (businessId: number) =>
    api.get(`/settings/${businessId}/export/products`, {
      responseType: 'blob'
    }),
  exportTransactions: (businessId: number) =>
    api.get(`/settings/${businessId}/export/transactions`, {
      responseType: 'blob'
    }),
};
